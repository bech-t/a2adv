/* font8x8.h -- police bitmap 8x8, domaine public ("Public Domain"),
 * issue de font8x8 par Daniel Hepper <daniel@hepper.net>
 * (https://github.com/dhepper/font8x8), lui-meme base sur les polices VGA
 * IBM domaine public reconstituees par Marcel Sondaar. Reduite a ce dont ce
 * portage a besoin (cf. scr.c) : ASCII imprimable 0x20-0x7E (font_ascii) et
 * bloc Latin-1 accentue U+00A0-U+00FF (font_latin1) -- le fichier original
 * couvre aussi grec, hiragana, box-drawing, etc., non repris ici.
 *
 * Format inchange par rapport a la source : 8 octets par glyphe, un par
 * rangee, bit 0 = pixel de GAUCHE (verifie a la relecture, cf. scr.c). */
#ifndef A2ADV_FONT8X8_H
#define A2ADV_FONT8X8_H
...
static const u8 font_latin1[96][8] = {
    {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},
